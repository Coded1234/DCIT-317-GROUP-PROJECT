		...
		<ul>
			...
			<li>Products</a>
				<ul>
					...
					<li><a href="admin_product.php " style="font-size:15px; margin-left:15px;">Sneakers</a></li>

					<li><a href="admin_running.php" style="font-size:15px; margin-left:15px;">Slides</a></li>
				</ul>
			</li>
				...
				<div id="printablediv">
					<center>
						<table class="table" style="width:50%;">
							<label style="font-size:25px;">KB'S Footwear Inc.</label>
