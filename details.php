...
<body>
	...
	<div id="container">
		...
		?>
			<div>
				<center>
					<img class="img-polaroid" style="width:400px; height:350px;" style="border-top-width: 0px;" src="photo/<?php echo $row['product_image']; ?>">
					<h2 class="text-uppercase bg-primary"><?php echo $row['product_name'] ?></h2>
					<h3 class="text-uppercase">GHS <?php echo $row['product_price'] ?></h3>
			...
			<div class="modal-body">
				<form method="post">
					<center>
						...
						<br />
						<h4>Total: GHS <?php echo $row['product_price']; ?> </h4>
						<br />
						<input type="checkbox" required> I Agree the <a href="#terms" data-toggle="modal"> Terms and Condition</a> of KB'S Footwear Inc.
					</center>
			</div>
			<div class="modal-footer">
				<center>
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">KB'S Footwear Inc. Terms and Condition</h3>
			</div>
			<div class="modal-body">
				<ul>
